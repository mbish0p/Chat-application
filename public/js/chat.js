...
const $messages = document.querySelector('#messagePlace')


// Templates
const messageTemplate = document.querySelector('#message-template').innerHTML
const locationMessageTemplate = document.querySelector('#location-template').innerHTML
const sidebarListOfUsers = document.querySelector('#sidebar-tamplate').innerHTML
...
const autoscroll = () => {
    ...
    if (containerHight - newMessageHeight <= scrollOffset) {
...
socket.on('userList', ({ room, users }) => {
    ...
    const html = Mustache.render(sidebarListOfUsers, {
        room,
        users
    })
...
$messageForm.addEventListener('submit', (e) => {
    ...
    socket.emit('messageToOthers', message, (error) => {
